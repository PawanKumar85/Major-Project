const BASE_URL = "https://localhost:4001/api/v1"
...
export const endpoints = {
  ...
  RESETPASSTOKEN_API: BASE_URL + "/auth/reset-token",
  RESETPASSWORD_API: BASE_URL + "/auth/reset",
}
...
export const courseEndpoints = {
  ...
  COURSE_DETAILS_API: BASE_URL + "/course/courses",
